...
<div class="page-content">
                ...
                @foreach($cvExperience as $cvExperience)
                    <div class="play-box">
                        ...
                        <div style="margin-bottom:10px;">
                            ...
                            <p>{{$cvExperience->city_town}}, {{$cvExperience->country}} <b style="font-size:25px">|</b> {{$cvExperience->start_date}} - 
                        ...
                        <a href="{{url('experience-details')}}" style="color:#0095FF"><b>&plus; add descriptions</b></a>
                        <br>
                    </div>
                @endforeach
            </div>
        ...
        <div class="control-btn">
            ...
            <a href="{{url('more-experience')}}" ><li class="cbs-btn" style="margin-left:30%;width:auto;background-color:#0095FF;border-style:none;color:#fff;"><h3>&plus; Add more experience</h3></li></a>
            <a href="{{url('education')}}"><li class="cbs-btn1"><h3>Continue</h3></li></a>
        </div><br><br><br><br><br>
    </div>
