...
@section('content')
    ...
    <div class="page-content">
        <div style="margin-top:60px;margin-bottom:20px;">
            <h1 style="margin-bottom:10px;">Review your experience</h1>
        </div>
        ...
        <div class="rbs-content">
            <div class="double-box" style="width:50%;display:grid;">
                @foreach ($cvExperience as $cvExperience)
                    <div class="play-box">
                        <div class="action">
                            <a href="{{ url('experience/update/' . $cvExperience->id) }}">
                            ...
                            <a href="{{ url('experience/delete/' . $cvExperience->id) }}">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    fill="#0095FF" height="23px" width="23px" version="1.1" id="Layer_1"
                        ...
                        <div style="margin-bottom:10px;">
                            <h2>{{ $cvExperience->job_title }}| {{ $cvExperience->company }}</h2>
                            <p>{{ $cvExperience->city_town }}, {{ $cvExperience->country }} <b style="font-size:25px">|</b>
                                {{ $cvExperience->start_date }} -
                                @if ($cvExperience->end_date == null)
                                    {{ 'current' }}
                                @else
                        ...
                        @if (empty($cvExperience->responsibilities))
                            <a href="{{ url('experience-details/' . $cvExperience->id) }}" style="color:#0095FF"><b>&plus;
                                    add
                                    descriptions</b></a>
                        @else
                            <p>
                            ...
                            <a href="{{ url('respnosibilities/update/' . $cvExperience->id) }}" style="color:#0095FF"><b>
                                    update
                                    descriptions</b></a>
                        @endif
                        <br>
        ...
        <div class="control-btn">
            ...
            <a href="{{ url('more-experience') }}">
                <li class="cbs-btn"
                    style="margin-left:30%;width:auto;background-color:#0095FF;border-style:none;color:#fff;">
                    <h3>&plus; Add more experience</h3>
                </li>
            </a>
