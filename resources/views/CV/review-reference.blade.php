...
<div class="page-content">
        <div style="margin-top:60px;margin-bottom:20px;">
            <h1 style="margin-bottom:10px;">Review your references</h1>
        </div>

        <div class="rbs-content">
            <div class="double-box" style="width:60%;display:grid;">
            <!-- loop -->
                @foreach($cvReference as $cvReference)
                <div class="play-box">
                        <div class="action">
                            <a href="">
                        ...
                        <div style="margin-bottom:10px;">
                            <h2>{{$cvReference->fullname}}</h2>
                            <p>{{$cvReference->position}}<b style="font-size:25px">|</b> {{$cvReference->company}}</p>
                        </div>
                        <p>
                            Email: {{$cvReference->email}} <br>
                            Tel: {{$cvReference->telephone}}
                        </p>
                        <a href="{{url('#')}}" style="color:#0095FF"><b>&plus; add descriptions</b></a><br>
                </div>
                @endforeach
            <!-- end loop -->
        ...
        <div class="control-btn">
            ...
            <a href="{{url('more-reference')}}" ><li class="cbs-btn" style="margin-left:30%;width:auto;background-color:#0095FF;border-style:none;color:#fff;"><h3>&plus; Add more reference</h3></li></a>
            <a href="{{url('finalize')}}"><li class="cbs-btn1"><h3>Continue</h3></li></a>
        </div><br><br><br><br><br>
    </div>
