...
<div class="page-content">
        <div style="margin-top:60px;margin-bottom:20px;">
            <h1 style="margin-bottom:10px;">Update educational details</h1>
        </div>

        <div style="width:100%;height:auto;gap:20px;margin-top:35px;">
            <form id="update-education-info" action="{{url('update-education-info/'.$data->id)}}" method="post">
                @csrf
                @method('PUT')
                        ...
                        <div class="rbs-layer-box">
                            <div class="rbs-layer">
                                <div>
                                    ...
                                    <input class="rbs-input" type="text" name="institution"  value="{{$data->institution}}" placeholder="Accra Institue of Technology">
                                </div>
                                <div>
                                    <label for="location">School Location</label>
                                    <input class="rbs-input" type="text" name="location" value="{{$data->location}}" placeholder="Kokomele">
                                </div>
                            </div>
                            ...
                            <div class="rbs-layer">
                                <div>
                                    ...
                                    <select type="text" name="certification" value="{{$data->certification}}">
                                ...
                                <div>
                                    ...
                                    <input class="rbs-input" type="text" name="field_of_study" value="{{$data->field_of_study}}" placeholder="Information Technology">
                                </div>
                            </div>
                        ...
                        <div class="rbs-layer-box">
                            <div class="rbs-layer">
                                    <div>
                                        ...
                                        <input class="rbs-input" type="date" value="{{$data->start_date}}" name="start_date">
                                    </div>
                            </div>
...
<script>
    function submitform(){
        var form = document.getElementById('update-education-info');
        form.action = "{{url('update-education-info/'.$data->id)}}";
        form.submit();
    }
</script>
@endsection