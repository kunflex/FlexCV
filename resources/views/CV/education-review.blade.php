...
<div class="page-content">
        ...
        <div class="rbs-content">
            ...
            @foreach($cvEducation as $Education)
               <div class="play-box">
                    <div class="action">
                        <a href="{{url('education/update/'.$Education->id)}}">
                        ...
                        <a href="{{url('education/delete/'.$Education->id)}}">
                    ...
                    <a href="{{url('education-details')}}" style="color:#0095FF"><b>&plus; add descriptions</b></a><br>
               </div>
            @endforeach
            </div>
