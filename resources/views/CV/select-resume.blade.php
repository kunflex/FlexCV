    ...
    <form action="{{ route('processForm') }}" method="post">
        ...
        <div class="rbs-content">
            <a>
                <div class="rbs-card">
                    <div>
                        <svg fill="#0095FF" height="60px" width="60px" version="1.1" id="Layer_1"
...
@section('content')
    <div style="margin-top:60px;margin-bottom:20px;">
        <h1 style="margin-bottom:10px;">How do you want to build your resume?</h1>
    </div>
<form action="{{ route('processForm') }}" method="post">
    @csrf
    <div class="rbs-content">
        <a>
            <div class="rbs-card"> 
                <div>
                    <svg fill="#0095FF" height="60px" width="60px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                        viewBox="0 0 491.52 491.52" xml:space="preserve">
                        <g>
                            <g>
                                <polygon points="334.879,7.93 334.879,94.307 421.256,94.307 		"/>
...
<<<<<<< HEAD
                            ...
                            <g>
                                <g>
                                    <polygon
                                        points="182.486,161.503 175.707,156.974 183.725,171.556 185.343,169.342 185.374,169.303 186.283,168.068 
                                    188.267,165.368 		" />
                                </g>
                            </g>
                            <g>
                                <g>
                                    <path
                                        d="M231.121,52.818c-2.315-0.558-4.266-2.129-5.295-4.274c-1.03-2.152-1.045-4.645-0.031-6.805
=======
                                    z"/>
                            </g>
                        </g>
...
<<<<<<< HEAD
                            ...
                            <g>
                                <g>
                                    <path
                                        d="M279.741,183.091c-0.658-3.948-3.398-7.247-7.169-8.609l-33.933-12.28l-15.329,27.881c-1.3,2.376-3.723,3.918-6.426,4.095
...
=======
                ...
                <input class="rbs-radio" type="radio" name="upload-resume" id="upload-resume" onclick="Activemenu(1)">
            </div>
        </a>
    </div>

    <div class="control-btn">
        <button class="cbs-btn1"><h3>Continue</h3></button>
</form>
...
>>>>>>> 0cd43fb34b4b876699950693d30d1e00ea7cf206
        ...
        // Add event listener for "upload-resume" radio button
<<<<<<< HEAD
...
>>>>>>> 0cd43fb34b4b876699950693d30d1e00ea7cf206
            if (uploadResumeRadio.checked) {
                newResumeRadio.checked = false; // Uncheck "new-resume"
            }
        });

        // Add event listener for "new-resume" radio button
<<<<<<< HEAD
...
>>>>>>> 0cd43fb34b4b876699950693d30d1e00ea7cf206
            if (newResumeRadio.checked) {
                uploadResumeRadio.checked = false; // Uncheck "upload-resume"
            }
        });
    });
</script>
