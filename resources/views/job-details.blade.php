   ...
   <div class="flow-color">
        <div>
                    ...
                    <div class="job-display">
                        <div class="job-list">
                            ...
                            <div class="display-contact">
                                    <div class="icon-dsc">
                                        <svg width="20px" height="20px" viewBox="0 0 36 36" version="1.1"  preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <div class="content-bx">
                ...
                <ul>
                    <li class="bullets">Bachelor's degree in Marketing, Business, or related field. Master's degree is a plus.</li>
                    <li class="bullets">Minimum of 5 years of experience in B2B technology marketing, with a focus on campaign management and digital marketing.</li>
                    <li class="bullets">Proven success in developing and implementing strategic marketing plans that contributed to business growth.</li>
                    <li class="bullets">Strong analytical skills with the ability to interpret data and make data-driven decisions.</li>
            ...
            <div class="form-bx">
                ...
                <div class="input-box">
                        ...
                        <input class="input-file" type="file" name="letter" id="letter" accept=".pdf" required>
                </div>
                ...
                <div class="input-box">
                        ...
                        <input class="input-file" type="file" name="letter" accept=".pdf" id="cv" required>
                </div>

                <div class="input-box" style="display:inline-flex;gap:10px;">
                        <div>
                            <input type="checkbox" name="checkbox" id="checkbox" onclick="approved()" style="height:16px;width:16px;margin-top:0px" required>
                        </div>
            ...
            <div class="NB-bx">
                ...
                <div class="NB-content">
                    <ul>
                        <li class="bullets">Applicants should know that only successful applicants would receive an email</li>
                        <li class="bullets">Applicants are requested to submit a resume and cover letter in PDF format via the online application portal</li>
                        <li class="bullets">Please ensure all application materials, including a comprehensive CV and a brief statement of interest, are submitted by the specified deadline</li>
                        <li class="bullets">Kindly note that only complete applications, including a resume, cover letter, and two professional references, will be considered</li>
                        <li class="bullets">Ensure your application package includes a resume, a cover letter outlining your suitability for the role, and any relevant certifications or portfolio links</li>
                        <li class="bullets">All applicants must provide contact information for two professional references along with their resume and cover letter</li>
                        <li class="bullets">Please adhere to the specified word limit when submitting your responses to the supplemental questions in the online application form</li>
                        <li class="bullets">Applicants are encouraged to carefully review the job description and tailor their cover letter to highlight how their skills align with the outlined requirements</li>
                    </ul>
                </div>
            <br><br>
   </div>
