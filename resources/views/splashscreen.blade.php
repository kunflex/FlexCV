...
<body>
    ...
    <div class="container_left">
        ...
        <div class="div-tri" style="margin-top:400px;gap:20px;">
            <div class="icon-symbol">
                <img src="{{asset('assets/img/portrait-young-woman-with-laptop-hands-outside-school.jpg')}}" alt="">
                <img src="{{asset('assets/img/portrait-young-woman-with-laptop-hands-outside-school.jpg')}}" alt="">
                <img src="{{asset('assets/img/portrait-young-woman-with-laptop-hands-outside-school.jpg')}}" alt="">
                <img src="{{asset('assets/img/portrait-young-woman-with-laptop-hands-outside-school.jpg')}}" alt="">
                <img src="{{asset('assets/img/portrait-young-woman-with-laptop-hands-outside-school.jpg')}}" alt="">
...
<style>
    *{
    ...
    .logo-design h1 span {
        ...
        animation: fadeIn 0.1s ease forwards; /* Adjust duration as needed */
        opacity: 0; /* Start with characters invisible */
    }

    .logo-design h1:nth-child(1) span { animation-delay: 0.3s; }
    .logo-design h1:nth-child(2) span { animation-delay: 0.5s; }
    .logo-design h1:nth-child(3) span { animation-delay: 0.7s; }
    .logo-design h1:nth-child(4) span { animation-delay: 0.9s; }
    .logo-design h1:nth-child(5) span { animation-delay: 1.1s; }
    .logo-design h1:nth-child(6) span { animation-delay: 1.3s; }

    .logo-design h1:after {
        content: ''; /* Create a pseudo-element for the cursor */
        display: inline-block;
        width: 0;
