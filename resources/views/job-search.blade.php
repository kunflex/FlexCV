<x-app-layout>
    ...
    <!-- =====Search bar====== -->
    <form action="{{ route('search.jobs1') }}" method="get">
        <div class="dv-search-bar">
            <input type="search" class="dv-input" placeholder="Search for jobs..." name="search">
            <button class="dv-btn">
                ...
                @forelse ($job as $job)
                    <div class="job-list">
                        ...
                        <div class="display-down">
                            ...
                            <div class="display-contact" style="color:gray;">
                                ...
                                Posted {{$job['job']->created_at->diffForHumans()}}</div>
